...
CLOUD_OAUTH_SCOPE = 'https://www.googleapis.com/auth/cloud-platform'
...
def _load_credentials(credentials_path):
    ...
    with open(credentials_path, 'r') as f:
        ...
        if 'access_token' in credentials_data:
            ...
            credentials_data['scopes'] = [_ASSISTANT_OAUTH_SCOPE, CLOUD_OAUTH_SCOPE, DRIVE_OAUTH_SCOPE]
    if migrate:
...
def _credentials_flow_interactive(client_secrets_path):
    flow = google_auth_oauthlib.flow.InstalledAppFlow.from_client_secrets_file(
        client_secrets_path,
        scopes=[_ASSISTANT_OAUTH_SCOPE, CLOUD_OAUTH_SCOPE, DRIVE_OAUTH_SCOPE])
